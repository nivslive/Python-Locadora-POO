class Locadora(object):
    ...
    def lista_alugados(self):
        if len(self.AluguelCarro) > 0:
            ...
            print(f"\nTotal de veículos é: {len(self.AluguelCarro)}\n")
        else:
...
class Carro(Locadora):
    def _init_(self, placa, ano, categoria, transmissao, combustivel, marca, modelo, aluguel):
        self.placa = placa
        self.ano = ano
